...
const DEFAULT_DATA = {
  settings: {
    userName: '박성혁',
    companyName: '루멘트',
    bizNumber: '8800303743',
    companyAddress: '인천광역시 연수구 인천타워대로 301, 에이동10층14호(송도동,송도센텀하이브)',
    bizType: '정보통신업',
    bizItem: '데이터베이스 및 온라인 정보 제공업',
    companyEmail: 'lument89@daum.net',
    managerPhone: '010-2428-0003',
    managerEmail: 'stylepsh@gmail.com',
